  ...
  return (
    <Container>
      <VerticalScroll showsVerticalScrollIndicator={false}>
        ...
        <TitleContainer>
          <Title>Qualidades/Defeitos</Title>
        </TitleContainer>
        <Body>
          <Row>
            <Input />
          ...
          <TitleContainer>
            <Title>Humanidade/Trilha</Title>
          </TitleContainer>
          <DotContainer>
            <Dots levels={sheetSkeleton.beast.fields.levels} title="asdasd" />
          </DotContainer>
          ...
          <DotContainer>
            <Dots levels={sheetSkeleton.beast.will.levels} title="asdasd" />
          </DotContainer>
          <DotContainer>
            <Dots
              levels={sheetSkeleton.beast.fields.levels}
              title="will"
              square
            />
          </DotContainer>
          ...
          <TitleContainer>
            <Title>Pontos de Sangue</Title>
          </TitleContainer>
          <DotContainer>
            <Dots
              levels={sheetSkeleton.beast.blood.levels}
              title="blood"
              square
            />
          </DotContainer>
          <TitleContainer>
            <Title>Vitalidade</Title>
          </TitleContainer>
          <Vitality
            levels={sheetSkeleton.beast.health.levels}
            labels={sheetSkeleton.beast.health.labels}
            numberLabels={sheetSkeleton.beast.health.numberLabels}
            title="Vitality"
          />
        </Body>
      </VerticalScroll>
